...
If objExcel.Cells(intRow, 1).Font.Color = RGB(255, 0, 0) Then
    logFile.Write "(" & (intRow - 1) & ") " & send_to & vbCrLf & _
                  ...
                  "     Error: This item will be skipped as it's determined Invalid... (Red Font; Not found in Master.xlsx)" & vbCrLf

    'MsgBox "Skipping this one..."
    GoTo NextIteration
ElseIf objExcel.Cells(intRow, 24).Value = "" Then
    logFile.Write "(" & (intRow - 1) & ") " & send_to & vbCrLf & _
                  "     Filename: " & file_left & vbCrLf & _
